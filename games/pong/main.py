...
# Generic function for performing ball and all rectangle collisions
...
# TASK 4.2 - Set the conditions for winning the game
# TASK 4.3 - End the game according to the set conditions


def load_scores():  # Read Player Score Data as docstring
    pass


def save_scores():  # Write the change in player scores after a game back to the storage file.
    pass


def update_scores():  # Update players' scores based on game results
    pass
...
while running:
    # TASK 5 - Add more information
    # TASK 5.1 - Prompts the player about the conditions for winning before starting the game
    # TASK 5.2 - Display the player's name in the upper-left and upper-right corners, respectively, as the game progresses
    # TASK 5.3 - Adds background music to the game. (Needs to loop during the game and stop at the end of the game)
    # TASK 5.4 - A match point tone is played when one player reaches the match point (when four points have been scored)
    ...
    for event in pygame.event.get():
        ...
        if is_playing and not is_reset:
            ...
            # The speed of the player also indicates the direction of the player's movement
    ...
    # TASK 1.2 - Updating the player movement
    ...
    if is_game_over and not is_playing:
        pass
